    ...
    public class AD_Proj_Proyectos : IAD_Proj_Proyectos
    {
        public string Eliminar(string esquema, string id)
        {
            ...
            using (SqlConnection cn = new SqlConnection(AccesConfig.Cadena_Connection))
            {
                ...
                {
                    cn.Open();
                    SqlCommand command = new SqlCommand(Varias.FormatObjectSQL(esquema, "uspDelProj_Proyectos"), cn);
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(new SqlParameter() { ParameterName = "@Proj_ProyectosId", DbType = DbType.Int32, Direction = ParameterDirection.Input, Value = id });
        ...
        public string Guardar(string esquema, C_Proj_Proyectos item)
        {
            ...
            using (SqlConnection cn = new SqlConnection(AccesConfig.Cadena_Connection))
            {
                ...
                {
                    cn.Open();
                    SqlCommand command = new SqlCommand(Varias.FormatObjectSQL(esquema, "uspInsertProj_Proyectos"), cn);
                    command.CommandType = CommandType.StoredProcedure;
        ...
        {
            List<C_Proj_Proyectos> _LisHistorial_Puestos = new List<C_Proj_Proyectos>();
            ...
            return new CollectionPage<C_Proj_Proyectos>
            {
        ...
        public string Modificar(string esquema, C_Proj_Proyectos item)
        {
            ...
            using (SqlConnection cn = new SqlConnection(AccesConfig.Cadena_Connection))
            {
                ...
                {
                    cn.Open();
                    SqlCommand command = new SqlCommand(Varias.FormatObjectSQL(esquema, "usUpdProj_Proyectos"), cn);
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(new SqlParameter() { ParameterName = "@Proj_ProyectosId", DbType = DbType.Int32, Direction = ParameterDirection.Input, Value = item.Proj_ProyectosId });
                    command.Parameters.Add(new SqlParameter() { ParameterName = "@NombreProyect", DbType = DbType.String, Direction = ParameterDirection.Input, Value = item.NombreProyect });
                    command.Parameters.Add(new SqlParameter() { ParameterName = "@UrlAddress", DbType = DbType.String, Direction = ParameterDirection.Input, Value = item.UrlAddress });
                    command.Parameters.Add(new SqlParameter() { ParameterName = "@Descripcion", DbType = DbType.String, Direction = ParameterDirection.Input, Value = item.Descripcion });
                    command.Parameters.Add(new SqlParameter() { ParameterName = "@Proj_PerfilId", DbType = DbType.Int32, Direction = ParameterDirection.Input, Value = item.Proj_Perfil.Proj_PerfilId });
        ...
        {
            C_Proj_Proyectos Proj_Proyectos = new C_Proj_Proyectos();
            ...
            using (SqlConnection cn = new SqlConnection(AccesConfig.Cadena_Connection))
            {
                try
                {
                    ...
                    using (var dr = command.ExecuteReader())
                    {
                        while (dr.Read())
                        {
                            Proj_Proyectos = new C_Proj_Proyectos()
                            {
                                Proj_ProyectosId = DataUtility.ObjectToInt(dr["Proj_ProyectosId"]),
                                NombreProyect = DataUtility.ObjectToString(dr["NombreProyect"]),
                                UrlAddress = DataUtility.ObjectToString(dr["UrlAddress"]),
