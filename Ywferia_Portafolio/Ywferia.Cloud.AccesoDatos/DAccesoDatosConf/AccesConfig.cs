namespace Ywferia.Cloud.AccesoDatos.DAccesoDatosConf
{
    public static class AccesConfig
    {
        ...
        public static string Cadena_Connection { get { return @"Data Source=.;Initial Catalog=TSQLDB000001; User ID=ywferia; Password=ywferia.-*123;Application Name=Portafolio"; } set { Cadena_Connection = value; } }
